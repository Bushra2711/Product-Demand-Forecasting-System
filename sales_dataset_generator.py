...
def generate_sales_dataset(num_entries=200000):
    """
    Generate a sales dataset with the following columns:
    - Product name
    - Cost
    - Year
    - Monthly sales
    ...
    # Product names (you can modify this list as needed)
    product_names = [
    ...
    for _ in range(num_entries):
        ...
        year_factor = 1.0 + (year - 2020) * 0.1  # 10% growth per year
...
def main():
    ...
    # Save to CSV
    output_file = 'sales_dataset_200k.csv'
