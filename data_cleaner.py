...
def main():
    ...
    cleaner = DataCleaner('sales_dataset_200k.csv')
    ...
    print("\nData cleaning and sanitization completed successfully!")
    print("Milestone 1 achieved: Dataset created, cleaned, and sanitized")
